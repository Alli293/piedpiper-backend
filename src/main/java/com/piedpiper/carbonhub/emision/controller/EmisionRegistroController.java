...
/** Registro y actualización de emisiones por categoría (electricidad, flota, envío, vuelo). */
@RestController
@RequestMapping("/api/emisiones")
@PreAuthorize("hasAnyRole('ADMINISTRADOR_EMPRESA', 'USUARIO_GENERAL')")
public class EmisionRegistroController {
    ...
    public EmisionRegistroController(EmisionElectricidadService emisionElectricidadService,
