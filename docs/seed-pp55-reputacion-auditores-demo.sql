...
VALUES
('bb550001-0000-0000-0000-000000000001', 'Café del Valle S.A.', '3-101-955001', 'AGROINDUSTRIA', 'CR', 48, 'admin+cafe-valle@carbonhub.test', 'https://demo.carbonhub.test/cafe-valle', NULL, 'cafe-del-valle-demo', 'Beneficio cafetalero con inventario GEI anual.', 'PLATA', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000002', 'Transporte Verde del Istmo S.A.', '3-101-955002', 'TRANSPORTE', 'CR', 95, 'admin+transporte-verde@carbonhub.test', 'https://demo.carbonhub.test/transporte-verde', NULL, 'transporte-verde-istmo-demo', 'Operador logístico con flotilla híbrida.', 'BRONCE', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000003', 'Textiles Naranjo S.R.L.', '3-101-955003', 'MANUFACTURA', 'CR', 130, 'admin+textiles-naranjo@carbonhub.test', 'https://demo.carbonhub.test/textiles-naranjo', NULL, 'textiles-naranjo-demo', 'Planta manufacturera con programa de eficiencia energética.', 'PLATA', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000004', 'Mercado Circular S.A.', '3-101-955004', 'RETAIL', 'CR', 62, 'admin+mercado-circular@carbonhub.test', 'https://demo.carbonhub.test/mercado-circular', NULL, 'mercado-circular-demo', 'Cadena retail con medición de huella por sucursal.', 'BRONCE', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000005', 'Servicios Climáticos Integrados S.A.', '3-101-955005', 'SERVICIOS', 'CR', 38, 'admin+servicios-climaticos@carbonhub.test', 'https://demo.carbonhub.test/servicios-climaticos', NULL, 'servicios-climaticos-demo', 'Empresa de consultoría y servicios ambientales.', 'ORO', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000006', 'Hotel Bahía Azul S.A.', '3-101-955006', 'HOTELERIA', 'CR', 84, 'admin+bahia-azul@carbonhub.test', 'https://demo.carbonhub.test/bahia-azul', NULL, 'hotel-bahia-azul-demo', 'Hotel costero con operación de turismo sostenible.', 'ORO', 'ACTIVO', NOW()),
('bb550001-0000-0000-0000-000000000007', 'Fundación Bosque Vivo', '3-101-955007', 'OTRO', 'CR', 24, 'admin+bosque-vivo@carbonhub.test', 'https://demo.carbonhub.test/bosque-vivo', NULL, 'fundacion-bosque-vivo-demo', 'Organización de restauración ecológica y educación ambiental.', 'PLATA', 'ACTIVO', NOW())
