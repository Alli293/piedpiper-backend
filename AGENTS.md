...
**Read [docs/CONVENTIONS.md](docs/CONVENTIONS.md) before writing or modifying any code.** It is the single source of truth for structure, naming, controllers, services, JPA entities, DTOs, validation, error handling, mappers, and tests. Follow it. If you need to deviate, say so explicitly and explain why — don't do it silently.
